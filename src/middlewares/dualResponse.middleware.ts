// src/middlewares/dualResponse.middleware.ts
 ...
 */
export const dualResponseMiddleware = (viewPath: string, pageData: any) => {
 ...
 */
export const createDualRoute = (viewPath: string, pageData: any) => {
