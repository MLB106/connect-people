 ...
 */
export const sensitiveAction = (resource, level = 1) => [
    ...
    (req, res, next) => {
        ...
        console.log('DEBUG sensitiveAction', {
            ...
            expectedCode: req.session?.confirmationCode,
            ip: req.ip,
            isStaticIPAllowed: isStaticIPAllowed(req.ip ?? ''),
            isBusinessHours: isBusinessHours(),
            userLevel: PERMISSION_MATRIX[req.user?.role]?.[resource] ?? 0,
            requiredLevel: level,
        });
        // 2.1 Rôle présent
        ...
        const expectedCode = req.session?.confirmationCode;
...
//# sourceMappingURL=sensitiveAction.middleware.js.map