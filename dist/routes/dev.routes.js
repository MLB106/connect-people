...
const createDevRoute = (path, viewName, dataFunction) => {
    devRouter.get(`/dev${path}`, async (req, res) => {
        try {
...
const createStaticDevRoute = (path, viewName, staticData) => {
    devRouter.get(`/dev${path}`, (_req, res) => {
        try {
...
createDevRoute('/api/nav/entreprendre', 'entreprendre/entreprendre-sourcing', async (_req, _res, _next) => {
...
createDevRoute('/api/footer/links', 'footer', async (_req, _res, _next) => {
...
createDevRoute('/api/search/categories', 'search', async (_req, _res, _next) => {
...
devRouter.get('/dev/test', (_req, res) => {
    res.json({
        success: true,
