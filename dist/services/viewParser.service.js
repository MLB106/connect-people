...
class ViewParserService {
     ...
     */
    async parseView(viewPath, pageData) {
        try {
     ...
     */
    parseSectionContent(className, content) {
        const section = {
     ...
     */
    getSectionType(className) {
        if (className.includes('hero'))
            return 'hero';
        if (className.includes('features'))
            return 'features';
        ...
        if (className.includes('stats'))
            return 'stats';
        if (className.includes('impact'))
            return 'impact';
        if (className.includes('contact'))
            return 'contact';
        if (className.includes('page-header'))
            return 'page-header';
        if (className.includes('mission-vision'))
            return 'mission-vision';
        if (className.includes('values'))
            return 'values';
        return 'content';
    }
    /**
...
//# sourceMappingURL=viewParser.service.js.map